...
<head>
  ...
  <title>ULOPS - Unlimited Learning Opportunities</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
   ...
   <!--    <h1 class="logo mr-auto"><a href="/">ULOPS</a></h1> -->
      <!-- Uncomment below if you prefer to use an image logo -->
       <a href="/" class="logo mr-auto"><img src="assets/ulopslogo.jpeg" alt="" class="img-fluid"></a>
...
Our strategic partnership with recruiting firms and success gives credence to our being one of the leading companies in Skill development</p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <h3>Enjoy the power of community</h3>
            <p class="font-italic">
              ULOPS does not leave you isolated. Rub minds with like-minded learners from all around the world and create your own click in the classroom
            </p>
            <ul>
              <li><i class="icofont-check-circled"></i> Powerful community features built into the system</li>
              <li><i class="icofont-check-circled"></i> Powerful community features built into the system</li>
              <li><i class="icofont-check-circled"></i> Powerful community features built into the system</li>
            </ul>
            <p>
           With ULOPS, the class follows you everywhere you go. You focus on learning while we focus on the technology.
            </p>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up">2320</span>
            <p>Students</p>
          </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Discover our diverse range of content</p>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="footer-top">
      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-6">
            <h3>ULOPS</h3>
            <p>Get the latest course and education updates from our list. We never spam your inbox</p>
          </div>
        </div>
        ...
        <div class="social-links">
          <a href="https://twitter.com/ulopskill" class="twitter" target="_blank"><i class="bx bxl-twitter"></i></a>
          <a href="https://facebook.com/ulopskill" class="facebook" target="_blank"><i class="bx bxl-facebook"></i></a>
          <a href="https://instagram.com/ulopskill" class="instagram" target="_blank"><i class="bx bxl-instagram"></i></a>
          
          <a href="https://www.linkedin.com/in/ulopskill" class="linkedin"><i class="bx bxl-linkedin" target="_blank" ></i></a>
        </div>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>ULOPS</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
